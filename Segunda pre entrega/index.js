 ...
 */
  /* const producto = productosArray.find((prod) => prod.id === producto);
if (producto) {
  ...
  decision = parseInt(
    prompt("Desea continuar comprando? 1 - Si . 2 - En otro momento")
  );
  if (decision === 1) {
    producto = parseInt(
      prompt(
...
alert(
  `El total de tu compra con descuento es de dolares ${totalCompraConDescuento}`
);
alert(
  `Felicidades, el total de tu descuento fue de dolares ${
